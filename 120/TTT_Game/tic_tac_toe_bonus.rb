...
module UI
  ...
  def prompt_name
    puts "Welcome #{human.name}! Your opponent is #{computer.name} the Pirate."
    double_horiz_rule
    puts "You're an 'X' | #{computer.name} the Pirate is an 'O'"
    double_horiz_rule
    empty_rule
    empty_rule
  end
...
class Computer < Player
  COMPUTER_NAMES = ['BlackBeard', 'Captain Kidd', 'Sir Francis Drake', 'Brad'].freeze
...
class TTTGame
  ...
  def play_again?
    ...
    loop do
      ...
      puts "Sorry. Please enter a 'y' or 'n'"
    end
  end
